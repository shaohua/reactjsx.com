...
var AppView = React.createClass({displayName: 'AppView',
  ...
  render: function() {
    var brand = React.DOM.a( {href:"/", className:"navbar-brand"}, "Reactjsx.com");
    ...
    var tableResults = _.map(sortedItems, function(item){
      return (
        React.DOM.tr(null, 
          React.DOM.td(null, 
            React.DOM.a( {target:"_blank", href:item.reactjsx && item.reactjsx.repoUrl}, 
              item.reactjsx && item.reactjsx.repoName
            )
          ),
          React.DOM.td(null, item.description),
          React.DOM.td(null, item.watchers_count),
          React.DOM.td(null, item.reactjsx && item.reactjsx.userName),
          React.DOM.td(null, moment(item.updated_at).lang('en').fromNow())
        )
      );
    });
    ...
    return (
      React.DOM.div(null, 
        Navbar( {componentClass:React.DOM.header, brand:brand, staticTop:true, className:"bs-docs-nav", role:"banner", toggleNavKey:0}, 
          Nav( {className:"bs-navbar-collapse", role:"navigation", key:0, id:"top"}, 
            React.DOM.li(null, 
              React.DOM.a( {href:"#", className:loginClassName,
                onClick:this.onLogin}, "Login with Github")
            ),
            React.DOM.li(null, 
              React.DOM.a( {href:"#", className:logoutClassName,
        ...
        Grid(null, 
          Row( {className:"show-grid"}, 
            Col( {xs:18, md:12}, 
              Jumbotron(null, 
                React.DOM.h2( {className:"center"}, "Search reusable React components"),
          ...
          Row( {className:"show-grid"}, 
            Col( {xs:18, md:12}, 
              ...
              React.DOM.div( {className:"oneline-input-container"}, 
                React.DOM.input( {type:"text",
...
_.extend(Proto, {
  ...
  initialize: function(){
    React.renderComponent(AppView(null ), this);
  }
});
